...
## Phase 10: 决策范式切换（2026-08-29 clarify——愿景 + 逐回合自主决策）[US1 修订]

**Goal**: 动作级批量计划 → "10 回合文字愿景 + 每 2 回合/关键事件的逐回合决策 + 动态储备纪律 + 上下文精炼"（spec FR-008 修订 / FR-017⑤ / FR-018 / SC-011；data-model §8；quickstart §4b）
...
- Polish: T047-T051 并行
- Phase 10: R001-R005/R008/R009 并行（不同文件）；R006 依赖 R001-R005+R007；R010 真机（用户在场）最后执行
